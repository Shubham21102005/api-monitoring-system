      ...
      <div className="max-w-7xl mx-auto px-6 py-20 lg:py-28 grid lg:grid-cols-12 gap-10 items-start">
        <div className="lg:col-span-7">
          ...
          <div className="mt-10 flex flex-wrap items-center gap-3">
            <Link to="/register" className="px-6 py-3 text-black font-bold hover:opacity-90 transition-opacity" style={{backgroundColor: NEON}}>
              START_MONITORING&nbsp;&rarr;
            </Link>
            <Link to="/login" className="px-6 py-3 border border-zinc-800 text-zinc-300 hover:border-zinc-600 hover:text-zinc-100 transition-colors">
              ./login
            </Link>
          </div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-px bg-zinc-900">
          {FEATURES.map((f) => (
            <div key={f.id} className="bg-black p-8 group hover:bg-zinc-950 transition-colors">
              ...
              <h3 className="font-bold tracking-wider mb-3 group-hover:opacity-80 transition-opacity" style={{color: NEON}}>
                {f.title}
              </h3>
  ...
  return (
    <section className="border-b border-zinc-900">
      <div className="max-w-7xl mx-auto px-6 py-24 text-center">
        ...
        <Link to="/register" className="inline-block mt-10 px-8 py-4 text-black font-bold hover:opacity-90 transition-opacity" style={{backgroundColor: NEON}}>
          [ DEPLOY_NOW ]
        </Link>
      </div>
    </section>
